...
<section class="login flex justify-center items-center">
    ...
    <div class="container bg-white flex justify-center items-center rounded-3xl">
        ...
        <div class="login-form">
            ...
            <form class="flex flex-col px-8" @submit.prevent="Login">

                <input type="hidden" name='type'>

                <input type="text" v-model="email" placeholder="Email" class="bg-transparent border-b-2"  required>
                <input type="password"  v-model="pwd" placeholder="Password" class="bg-transparent border-b-2" required>
                <input type="submit" class="text-center rounded-full bg-black text-white cursor-pointer" value="Log in">
