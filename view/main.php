...
<body>    
    ...
    <section class="flex justify-around flex-col" id="newProducts">
        ...
        <div class="header flex flex-col items-center gap-2">
           <span class="font-bold text-5xl font-mono my-5">News</span><img src="<?= URLROOT . '/view/assets/images/makeup.jpg' ?>" alt="makeup" style="border-radius:100%;width:50px;height:50px"/><span class="font-bold text-5xl font-mono">of makeup world and trends</span> 
        ...
        <div class="products items-center mb-10">
            ...
            <div class="product flex justify-center flex-col w-[30%]">
                ...
                <button class="my-3 hover:bg-gray-100 text-gray-800 font-semibold py-2 mx-32 border border-gray-400 rounded shadow">49.99$</button>
            ...
            <div class="product flex justify-center flex-col w-[30%]">
                ...
                <button class="my-3 hover:bg-gray-100 text-gray-800 font-semibold py-2 mx-32 border border-gray-400 rounded shadow">119.99$</button>
            ...
            <div class="product flex justify-center flex-col ">
    ...
    <footer class="p-5 sm:p-6">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="" class="flex items-center">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-black">GlowGuru</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-black">Legal</h2>
                    <ul class="text-gray-600 text-gray-400">
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center">© 2023 . designed and developed with love by Rabie Ouallaf.
            </span>
